...
var FAKE_LIGHT = {
  ...
  setPowerOn: function(on) { 
  	var status = "off";
  	var url = 'http://192.168.178.29:3000/buero'
...
var light = exports.accessory = new Accessory('Walllight', lightUUID);

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
light.username = "1A:2B:3C:4D:5E:DA";
...
light
  .addService(Service.Lightbulb, "Wandlicht") // services exposed to the user should have "names" like "Fake Light" for us
