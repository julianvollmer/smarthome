...
var OUTLET = {
  ...
  setPowerOn: function(on) { 
    var status = "0";
    var url = 'http://192.168.178.29:3000/outlet/1/'
...
var outlet = exports.accessory = new Accessory('OutletLivingroomTv', outletUUID);

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
outlet.username = "1A:2B:3C:4D:50:DD";
...
outlet
  .addService(Service.Outlet, "Steckdose Fernseher") // services exposed to the user should have "names" like "Fake Light" for us
